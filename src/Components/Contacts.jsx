...
const Contacts = () => {
  ...
  return (
    <div className="pt-16 text-black  p-4  w-full justify-center">
      <div className="m-4 justify-between">
        <button className="rounded-full shadow shadow-slate-700 font-bold bg-orange-500 p-3 text-2xl">
      ...
      >
        {AllContacts.map((el) => {
          return (
            <div
              key={el.id}
              className="bg-orange-400 rounded-md shadow-xl m-4 p-1 text-center text-white"
            >
